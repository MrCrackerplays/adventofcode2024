...
(function main () {
	...
	let has_truth = function(result, current_value, remaining_values) {
		...
		return has_truth(result, current_value + remaining_values[0], remaining_values.filter((_, i) => i !== 0))
			|| has_truth(result, current_value * remaining_values[0], remaining_values.filter((_, i) => i !== 0));
	}
	let total = 0;
